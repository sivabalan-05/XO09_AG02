...
test('a duration claim without separate work evidence does not satisfy the experience floor', () => {
  ...
  assert.equal(analysis.requirementCoverage.find((item) => item.id === 'experience').met, 0)
})
